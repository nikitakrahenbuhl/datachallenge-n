...
Several spatial outliers were identified [@fig-interactiv-map] and roughly removed by filtering the data to a step length of less than 2500 meters.

```{r, warning = FALSE}
#| label: fig-interactive-map
#| fig-cap: "Spatial extent of the deer dataset"
